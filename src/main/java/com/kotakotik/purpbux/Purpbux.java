...
import com.kotakotik.purpbux.screens.BuxStationScreen;
...
public class Purpbux
{
    ...
    public Purpbux() {
        ...
        LOGGER.info("the one probe is " + (ModList.get().getModContainerById("theoneprobe").isPresent() ?
                "present" : "not present")
        );
    }
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        ...
        ScreenManager.registerFactory(ModContainers.BUX_STATION_CONTAINER.get(), BuxStationScreen::new);
    }
